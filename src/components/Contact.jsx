...
import { FiMail, FiGithub, FiLinkedin, FiArrowUpRight, FiPhone } from 'react-icons/fi'
import { useLanguage } from '../context/LanguageContext'
import translations from '../i18n/translations'

const links = [
  { name: 'Email', value: 'marishg32@gmail.com', href: 'mailto:marishg32@gmail.com', icon: FiMail, color: '#c084fc' },
  { name: 'GitHub', value: 'github.com/Mariagato', href: 'https://github.com/Mariagato', icon: FiGithub, color: '#e8e0f0' },
  { name: 'LinkedIn', value: 'María Fernanda Hurtado', href: 'https://www.linkedin.com/in/mariafernandahurtadogomez/', icon: FiLinkedin, color: '#f9a8d4' },
  { name: 'WhatsApp', value: '+57 319 728 8689', href: 'https://wa.me/573197288689', icon: FiPhone, color: '#6ee7b7' },
]
    ...
    <section id="contact" className="py-24 px-6 relative bg-section-a section-divider">
      <div className="max-w-3xl mx-auto text-center relative" ref={ref}>
        ...
        <motion.div initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: 0.6, delay: 0.5 }}>
          <a href="mailto:marishg32@gmail.com" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-accent-pink to-accent-purple rounded-lg font-semibold text-white text-lg hover:shadow-lg hover:shadow-pink-400/25 transition-all duration-300 hover:-translate-y-0.5">
